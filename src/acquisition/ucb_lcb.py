...
class UCBLCBFilter:
    ...
    def compute_bounds(self, mu, std):
        """
        Compute UCB and LCB.
    ...
    def filter_candidates(self, defender_mu, defender_std, 
        ...
        for i, cand_id in enumerate(candidate_ids):
            ...
            cand_ucb, cand_lcb = self.compute_bounds(cand_mu, cand_std)
    ...
    def visualize_bounds(self, defender_mu, defender_std, 
        ...
        ax.set_title(f'UCB/LCB Filtering (β={self.beta})', fontsize=15, fontweight='bold')
